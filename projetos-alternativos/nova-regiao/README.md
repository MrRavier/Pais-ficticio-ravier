# Projeto alternativo — Sintica

Status: **em desenvolvimento**.

Este diretório é reservado para o país fictício **Sintica** e permanece totalmente separado do cânone de Valga–Valka.

## Território-base

- O território do país corresponde, em equivalência moderna, à área do atual **Município de Novo Selo, Macedônia do Norte**.
- A referência territorial é o município inteiro, não apenas a vila de Novo Selo.
- O nome moderno do Estado está fixado como **Sintica**.
- A forma política moderna prevista é a de um **principado soberano constitucional e parlamentar**, sob a **Casa de Orbelos**; detalhes constitucionais, títulos completos e cronologia de formação ainda permanecem em desenvolvimento.
- Fronteiras históricas e data de independência permanecem em aberto até decisão explícita do autor.
...
- O projeto deve preservar o máximo possível da história regional real até o ponto de divergência escolhido.
- Sintica é concebida como uma nação historicamente multilíngue e multiétnica, formada por camadas locais eslavas, gregas, valáquias/aromanas, otomanas/turcas e conexões posteriores húngaras e austríacas/germanófonas.
- A Casa de Orbelos funciona como dinastia histórica supracomunitária, cuja legitimidade política se constrói também por alianças, casamentos e patronagem entre essas comunidades.

## Próximos elementos a registrar

- ponto de divergência;
- território inicial em termos históricos;
- população e identidade linguística;
- constituição e poderes da Coroa;
- cronologia;
- tradição heroica do país dentro de *The Extraordinary World*.
